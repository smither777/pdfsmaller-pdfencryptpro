...
program
    ...
    try {
        ...
        const outputPath = options.output
            ...
            : encryptor_1.PDFEncryptor.generateOutputPath(inputPath, '_encrypted');
        ...
        const result = await encryptor_1.PDFEncryptor.encryptPDF(inputPath, outputPath, encryptionOptions);
        if (result.success) {
